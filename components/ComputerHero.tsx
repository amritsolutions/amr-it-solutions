...
export default function ComputerHero() {
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-white via-blue-50 to-white">
      <div className="mx-auto grid min-h-[760px] max-w-7xl items-center gap-12 px-6 py-20 lg:grid-cols-[0.9fr_1.1fr]">
        ...
        <div className="relative hidden min-h-[620px] lg:block">
          <div className="absolute left-[-120px] top-[-10px] h-[650px] w-[850px] rounded-[48%_52%_45%_55%/42%_48%_52%_58%] bg-blue-100" />
          <div className="absolute left-[-80px] top-12 h-[620px] w-[820px] rounded-[55%_45%_55%_45%/45%_55%_45%_55%] bg-blue-200/40 blur-3xl" />
