...
const benefits = [
  {
    Icon: HardDrive,
    title: "SSD-upgrades",
    text: "Sneller opstarten en programma’s veel vlotter gebruiken.",
  },
  {
    Icon: MemoryStick,
    title: "RAM uitbreiden",
    text: "Soepeler multitasken en betere dagelijkse prestaties.",
  },
  {
    Icon: ShieldCheck,
    title: "Virus verwijderen",
    text: "Je computer veilig opschonen en opnieuw beveiligen.",
  },
  {
    Icon: Wrench,
    title: "Hardware reparatie",
    text: "Defecte onderdelen zorgvuldig controleren en vervangen.",
  },
];
        ...
        <div className="mt-10 grid items-center gap-12 lg:grid-cols-[1.08fr_0.92fr] lg:gap-10">
          ...
          <div className="relative z-20">
            ...
            <h1 className="mt-7 text-4xl font-extrabold leading-[1.06] tracking-tight text-slate-950 sm:text-5xl lg:text-[56px] xl:text-[60px]">
              <span className="block">Geef jouw computer</span>
            ...
            <p className="mt-7 max-w-[620px] text-base leading-8 text-slate-600 sm:text-lg">
              Is jouw computer of laptop traag, instabiel of defect? AMR IT
              Solutions helpt met SSD-upgrades, RAM-uitbreidingen,
          ...
          <div className="relative min-h-[420px] lg:min-h-[560px]">
            ...
            <Image
              ...
              alt="Computer upgrade en reparatie in Breda door AMR IT Solutions"
              width={1000}
              height={760}
              priority
