      ...
      <div className="mx-auto max-w-5xl">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mx-auto mt-5 max-w-3xl text-base leading-8 text-slate-600 sm:text-lg">
            Hieronder vind je antwoorden op veelgestelde vragen over
            laptopoptimalisatie, SSD-upgrades en betere prestaties.
          </p>
        </div>
        ...
        <div className="mt-14 space-y-5">
          {faqs.map((faq, index) => {
            ...
            const panelId = `laptop-faq-panel-${index}`;
            const buttonId = `laptop-faq-button-${index}`;
