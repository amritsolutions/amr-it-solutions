...
const benefits = [
  {
    Icon: Zap,
    title: "Sneller opstarten",
    text: "Minder wachten en sneller aan het werk.",
  },
  {
    Icon: HardDrive,
    title: "SSD-upgrade",
    text: "Een flinke snelheidswinst voor je laptop.",
  },
  {
    Icon: Rocket,
    title: "Windows-optimalisatie",
    text: "Opschonen en instellingen slimmer afstellen.",
  },
  {
    Icon: Wrench,
    title: "Persoonlijk advies",
    text: "Duidelijk advies over de beste oplossing.",
  },
];
        ...
        <div className="mt-10 grid items-center gap-12 lg:grid-cols-[1.05fr_0.95fr] lg:gap-10">
          ...
          <div className="relative z-20">
            ...
            <h1 className="mt-7 text-4xl font-extrabold leading-[1.06] tracking-tight text-slate-950 sm:text-5xl lg:text-[56px] xl:text-[60px]">
              <span className="block">Laptop traag?</span>

              <span className="block">Wij maken hem</span>
            ...
            <p className="mt-7 max-w-[620px] text-base leading-8 text-slate-600 sm:text-lg">
              Is je laptop langzaam geworden? AMR IT Solutions helpt met
              Windows-optimalisatie, opschoning, SSD-upgrades en persoonlijk
              advies om je laptop weer soepel te laten werken.
            </p>
          ...
          <div className="relative min-h-[430px] lg:min-h-[570px]">
            ...
            <Image
              ...
              alt="Laptop sneller maken in Breda door AMR IT Solutions"
              width={1000}
              height={760}
              priority
