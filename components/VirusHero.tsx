...
const benefits = [
  {
    ...
    text: "Virussen en ongewenste software zorgvuldig verwijderen.",
  },
  {
    Icon: Bug,
    title: "Malware verwijderen",
    text: "Schadelijke programma’s opsporen en volledig verwijderen.",
  },
  {
    Icon: ScanSearch,
    title: "Volledige controle",
    text: "Je computer controleren op beveiligings- en prestatieproblemen.",
  },
  {
    Icon: MessageCircle,
    title: "Persoonlijk advies",
    text: "Duidelijke uitleg om nieuwe besmettingen te voorkomen.",
  },
];
        ...
        <div className="mt-10 grid items-center gap-12 lg:grid-cols-[1.05fr_0.95fr] lg:gap-10">
          ...
          <div className="relative z-20">
            ...
            <h1 className="mt-7 text-4xl font-extrabold leading-[1.06] tracking-tight text-slate-950 sm:text-5xl lg:text-[56px] xl:text-[60px]">
              <span className="block">Last van een virus</span>
            ...
            <p className="mt-7 max-w-[640px] text-base leading-8 text-slate-600 sm:text-lg">
              AMR IT Solutions controleert en reinigt jouw computer of laptop
              van virussen, malware en ongewenste software. Daarna helpen we je
              om nieuwe beveiligingsproblemen zoveel mogelijk te voorkomen.
            </p>
