    ...
    <section className="bg-white px-6 py-20">
      <div className="mx-auto max-w-6xl overflow-hidden rounded-[2.5rem] bg-gradient-to-br from-blue-600 via-blue-600 to-blue-700 px-10 py-20 text-center text-white shadow-[0_30px_80px_rgba(37,99,235,0.35)]">
        ...
        <h2 className="mt-4 text-4xl font-extrabold lg:text-5xl">
          Laat jouw website professioneel bouwen
        </h2>

        <p className="mx-auto mt-6 max-w-2xl text-lg leading-8 text-blue-100">
          Van ontwerp tot oplevering. Wij bouwen een moderne, snelle en
          SEO-vriendelijke website die vertrouwen uitstraalt en nieuwe klanten
          aantrekt.
        </p>
        ...
        <div className="mt-10 flex flex-wrap justify-center gap-5">
          ...
          <a
            href="/#contact"
            className="inline-flex items-center gap-3 rounded-2xl border-2 border-white px-8 py-4 font-bold text-white transition-all duration-300 hover:bg-green-500 hover:border-green-500"
          >
