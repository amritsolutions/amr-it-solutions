      ...
      <div className="relative">
        ...
        <div className="absolute inset-0 hidden lg:block">
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(90deg, rgba(255,255,255,1) 0%, rgba(255,255,255,0.99) 27%, rgba(255,255,255,0.94) 38%, rgba(255,255,255,0.58) 52%, rgba(255,255,255,0.08) 72%, rgba(255,255,255,0) 83%)",
            }}
          />
        ...
        <div className="relative mx-auto max-w-[1600px] px-6 pb-10 pt-12 sm:px-10 lg:min-h-[850px] lg:px-16 lg:pb-12 lg:pt-20 xl:px-20">
          {/* Mobiele foto apart weergegeven */}
          <div className="relative mb-8 h-[260px] overflow-hidden rounded-[1.75rem] sm:h-[340px] lg:hidden">
            <Image
              src="/images/hero.jpg"
              alt="Moderne IT-werkplek met laptop en serverapparatuur"
              fill
          ...
          <div className="flex min-h-0 flex-col lg:min-h-[758px]">
            <div className="max-w-[660px]">
              <div className="mb-7 inline-flex items-center gap-3 rounded-full bg-blue-50/95 px-5 py-3 text-xs font-bold uppercase tracking-wide text-blue-600 sm:text-sm">
                <span className="h-2.5 w-2.5 rounded-full bg-blue-600" />
                IT Support in Breda & omgeving
              </div>

              <h1 className="max-w-[650px] text-[2.75rem] font-extrabold leading-[1.06] tracking-[-0.045em] text-slate-950 sm:text-[3.7rem] lg:text-[4.25rem] xl:text-[4.55rem]">
                IT-oplossingen
                <br />
                voor particulieren
                <br />
              ...
              <p className="mt-7 max-w-[610px] text-base leading-7 text-slate-600 sm:text-lg sm:leading-8">
                ...
                Windows-installaties, Microsoft 365, websites, WiFi-problemen
                en betrouwbare IT-support in Breda en omgeving.
              </p>
              ...
              <div className="mt-9 flex flex-col gap-4 sm:flex-row sm:flex-wrap">
                ...
                <a
                  href="#diensten"
                  className="inline-flex min-h-14 items-center justify-center gap-3 rounded-2xl bg-white/95 px-7 py-4 text-sm font-semibold text-slate-800 shadow-sm ring-1 ring-slate-300 transition duration-200 hover:-translate-y-0.5 hover:bg-slate-50"
                >
                  <GridIcon />
                  Bekijk diensten
                </a>
            ...
            <div className="mt-12 grid gap-5 sm:grid-cols-2 lg:mt-auto lg:grid-cols-4 lg:pt-14">
              {features.map((feature) => {
                ...
                return (
                  <article
                    key={feature.title}
                    className="flex min-h-[132px] items-start gap-4 rounded-2xl bg-white/95 p-6 shadow-[0_12px_35px_rgba(15,23,42,0.10)] ring-1 ring-slate-200/90 backdrop-blur-md transition duration-200 hover:-translate-y-1 hover:shadow-[0_18px_45px_rgba(15,23,42,0.14)]"
                  >
