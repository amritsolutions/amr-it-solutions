...
const benefits = [
  {
    ...
    text: "E-mailaccounts instellen en problemen met Outlook oplossen.",
  },
  {
    Icon: Cloud,
    title: "OneDrive instellen",
    text: "Bestanden veilig opslaan, synchroniseren en terugvinden.",
  },
  {
    Icon: Users,
    title: "Teams gebruiken",
    text: "Hulp met vergaderen, chatten en samenwerken in Teams.",
  },
  {
    Icon: MessageCircle,
    title: "Persoonlijke hulp",
    text: "Duidelijke uitleg zonder ingewikkelde technische termen.",
  },
];
        ...
        <div className="mt-10 grid items-center gap-12 lg:grid-cols-[1.05fr_0.95fr] lg:gap-10">
          ...
          <div className="relative z-20">
            ...
            <h1 className="mt-7 text-4xl font-extrabold leading-[1.06] tracking-tight text-slate-950 sm:text-5xl lg:text-[56px] xl:text-[60px]">
              <span className="block">Hulp nodig met</span>
          ...
          <div className="relative min-h-[430px] lg:min-h-[570px]">
            ...
            <Image
              ...
              alt="Microsoft 365 hulp in Breda door AMR IT Solutions"
              width={1000}
              height={760}
              priority
