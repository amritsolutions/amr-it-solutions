...
const benefits = [
  {
    ...
    text: "Documenten, foto’s en andere bestanden veilig meenemen.",
  },
  {
    Icon: FolderSync,
    title: "Nieuwe computer instellen",
    text: "Alles netjes installeren en direct gebruiksklaar maken.",
  },
  {
    Icon: ShieldCheck,
    title: "Veilige back-up",
    text: "Belangrijke bestanden beschermen tegen verlies.",
  },
  {
    Icon: MessageCircle,
    title: "Persoonlijke hulp",
    text: "Duidelijke uitleg en begeleiding tijdens het hele proces.",
  },
];
  ...
  return (
    <section className="relative isolate overflow-hidden bg-gradient-to-br from-white via-blue-50/70 to-white">
      ...
      <div className="mx-auto max-w-[1440px] px-6 pb-20 pt-10 lg:px-10 xl:px-12">
        <Breadcrumb current="Data overzetten & back-up" />
        ...
        <div className="mt-10 grid items-center gap-12 lg:grid-cols-[1.05fr_0.95fr] lg:gap-10">
          ...
          <div className="relative z-20">
            ...
            <h1 className="mt-7 text-4xl font-extrabold leading-[1.06] tracking-tight text-slate-950 sm:text-5xl lg:text-[56px] xl:text-[60px]">
              <span className="block">Bestanden veilig</span>
            ...
            <p className="mt-7 max-w-[640px] text-base leading-8 text-slate-600 sm:text-lg">
              AMR IT Solutions helpt met het veilig overzetten van documenten,
              foto&apos;s, e-mail en instellingen naar een nieuwe computer. Ook
              helpen we met betrouwbare back-ups zodat je belangrijke bestanden
          ...
          <div className="relative min-h-[430px] lg:min-h-[570px]">
            ...
            <Image
              src="/images/data-hero.png"
              alt="Data veilig overzetten en back-up instellen in Breda"
              width={1000}
              height={760}
              priority
