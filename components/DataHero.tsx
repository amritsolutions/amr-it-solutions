...
const benefits = [
  {
    Icon: HardDrive,
    text: "Bestanden overzetten",
  },
  {
    Icon: FolderSync,
    text: "Nieuwe computer instellen",
  },
  {
    Icon: ShieldCheck,
    text: "Veilige back-up",
  },
  {
    Icon: MessageCircle,
      ...
      <div className="mx-auto grid min-h-[720px] max-w-7xl items-center gap-12 px-6 py-20 lg:grid-cols-[0.9fr_1.1fr]">
        <div className="relative z-20">
          ...
          <h1 className="mt-6 max-w-3xl text-4xl font-extrabold leading-[1.12] tracking-tight text-slate-950 sm:text-5xl lg:text-[52px]">
            Bestanden veilig overzetten naar je nieuwe computer
          </h1>
          ...
          <p className="mt-6 max-w-xl text-lg leading-8 text-slate-600">
            ...
            helpen we met betrouwbare back-ups.
          </p>
