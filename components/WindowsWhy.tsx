...
const reasons = [
  {
    ...
    text: "In veel gevallen installeren we Windows dezelfde dag of de volgende werkdag, zodat je snel weer aan de slag kunt.",
  },
  {
    Icon: ShieldCheck,
    title: "Veilig & betrouwbaar",
    text: "Windows wordt schoon geïnstalleerd, volledig bijgewerkt en voorzien van de juiste beveiligingsinstellingen.",
  },
  {
    Icon: MapPin,
  ...
  },
  {
    ...
    text: "Heldere uitleg, eerlijk advies en ondersteuning afgestemd op jouw computer of laptop.",
  },
];
      ...
      <div className="mx-auto max-w-7xl">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-5 text-lg leading-8 text-slate-600">
            ...
            volledig gebruiksklaar wordt opgeleverd, zodat je direct weer
            zorgeloos kunt werken.
          </p>
        </div>
