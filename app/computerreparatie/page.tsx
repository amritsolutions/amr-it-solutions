  ...
  <div className="mx-auto max-w-7xl px-6">
    ...
    <div className="mt-16 grid gap-8 md:grid-cols-2 lg:grid-cols-3">
      ...
      <div className="rounded-3xl border border-slate-200 bg-white p-8 shadow-sm">
        ...
        <h3 className="mt-4 text-xl font-bold">Trage computer</h3>
      ...
      <div className="rounded-3xl border border-slate-200 bg-white p-8 shadow-sm">
        ...
        <h3 className="mt-4 text-xl font-bold">Virus verwijderen</h3>
        <p className="mt-3 text-slate-600">
      ...
      <div className="rounded-3xl border border-slate-200 bg-white p-8 shadow-sm">
        <div className="text-4xl">⚙️</div>
        <h3 className="mt-4 text-xl font-bold">Windows installeren</h3>
        <p className="mt-3 text-slate-600">
      ...
      <div className="rounded-3xl border border-slate-200 bg-white p-8 shadow-sm">
        <div className="text-4xl">💾</div>
        <h3 className="mt-4 text-xl font-bold">SSD upgrade</h3>
        <p className="mt-3 text-slate-600">
      ...
      <div className="rounded-3xl border border-slate-200 bg-white p-8 shadow-sm">
        <div className="text-4xl">📂</div>
        <h3 className="mt-4 text-xl font-bold">Data overzetten</h3>
        <p className="mt-3 text-slate-600">
      ...
      <div className="rounded-3xl border border-slate-200 bg-white p-8 shadow-sm">
        <div className="text-4xl">🖨️</div>
        <h3 className="mt-4 text-xl font-bold">Printer & WiFi</h3>
        <p className="mt-3 text-slate-600">
  ...
  <div className="mx-auto max-w-7xl px-6">
    ...
    <div className="mt-16 grid gap-8 md:grid-cols-2">
      ...
      <div className="rounded-3xl bg-slate-50 p-8">
        <h3 className="text-xl font-bold">⚡ Snelle hulp</h3>
        <p className="mt-3 text-slate-600">
      ...
      <div className="rounded-3xl bg-slate-50 p-8">
        <h3 className="text-xl font-bold">👨‍💻 Persoonlijk contact</h3>
        <p className="mt-3 text-slate-600">
      ...
      <div className="rounded-3xl bg-slate-50 p-8">
        <h3 className="text-xl font-bold">📍 Breda & omgeving</h3>
        <p className="mt-3 text-slate-600">
      ...
      <div className="rounded-3xl bg-slate-50 p-8">
        <h3 className="text-xl font-bold">💬 Duidelijke uitleg</h3>
        <p className="mt-3 text-slate-600">
